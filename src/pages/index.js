...
const IndexPage = () => (
  <Layout>
    ...
    <TshirtListPage
      tshirts={[
        new Tshirt({ id: 1, tag: ["Tyrone"], name: "Call Tyrone", price: "35.00 USD", img_main: "./tyrone.png", description: "No time for small talk, tell Tyrone to leave you alone!", quantity: 5, sizes: ["Small", "Medium", "Large", "X-Large"], img_alt: ["./tyrone.png", "./tyrone.png"] }),
